...
class Client(threading.Thread):
	...
	def commandReciever(self):
		print "Start Recv form CMD SOCk"

		while True:
			raw_data = self.command_server.recv(1024)
			print raw_data
	...
	def driverSender(self):
		...
		while True:
			...
			"""
			Check if message is calling function
			"""
	...
	def run(self):
		...
		t2 = threading.Thread(target=self.commandReciever)
